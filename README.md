<h1 align="center">JS - Projeto Validador de formulários </h1>

# Índice
- [Índice](#índice)
- [🛠 Sobre o Projeto JS - Validador de formulários](#-sobre-o-projeto-js---validador-de-formulários)
...
---
# 🛠 Sobre o Projeto JS - Validador de formulários
...
```js
    ...
    $ git clone https://github.com/TayseRosa/js-validador-formularios.git

    //Entrar no diretório
    $ cd js-validador-formularios
